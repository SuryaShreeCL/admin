...
import { rootPath, rootLoginPath, coursePath, studentPath, departmentPath, collegePath, universityPath, cityPath, aspirationPath, questionSetPath, videoPath, productPath, webinarPath, careerTrackPath, notificationPath, clientDetailsPath, ratingPath, testimonialsPath, reportsPath, productBasedPath, starterPackPath,productPunchingPath, callSummaryLayoutPath, OnboardingAcademicInfoPath, OnboardingPersonalInfoPath, OnboardingPath } from './RoutePaths';
