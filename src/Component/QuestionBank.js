...
export default class QuestionBank extends Component {
    ...
    questionBank = [
        ...
        },
        {
            ...
            options: ['Architect,Design,Develop,Softwere Product', 'Plan and Get things Done', 'Analyse Information & Execute Projects', 'Engineer solutions to real world problems'],
        },
        {
            type: 'yes/no',
                                            ...
                                            <RadioGroup row aria-label="position" name="position" defaultValue="top">
                                                {
                                                    qus.options.map((op) => {
                                                        return (
                                                            <><FormControlLabel value={op} control={<Radio color="primary" />} label={op} /></>
                                                        )
                                                    })
                                                }
                                            </RadioGroup>
