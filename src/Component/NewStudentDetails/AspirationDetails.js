...
export class AspirationDetails extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.props.StudentDetails !== prevProps.StudentDetails) {
      this.setState({
        ...
        year: {
          title:
            this.props.aspirationDetails.year &&
            this.props.aspirationDetails.year.toString(),
          value:
            this.props.aspirationDetails.year &&
            this.props.aspirationDetails.year,
        },
  ...
  handleSubmit = () => {
    ...
    this.state.term.length === 0
      ? this.setState({ termHelperTxt: helpMsg })
      : this.setState({ termHelperTxt: '' });
    this.state.branch.length === 0
      ? this.setState({ branchHelperTxt: helpMsg })
      : this.setState({ branchHelperTxt: '' });
    this.state.degree.length === 0
      ? this.setState({ degreeHelperTxt: helpMsg })
      : this.setState({ degreeHelperTxt: '' });
    this.state.specialization.length === 0
      ? this.setState({ specializationHelperTxt: helpMsg })
      : this.setState({ specializationHelperTxt: '' });
    ...
    this.state.noOfSchool.length === 0
      ? this.setState({ noOfSchoolHelperTxt: helpMsg })
      : this.setState({ termHelperTxt: '' });
    this.state.year === null
      ? this.setState({ yearHelperTxt: helpMsg })
      : this.setState({ yearHelperTxt: '' });
...
const mapStateToProps = state => {
  console.log(
    'mapStateToProps.............',
    state.StudentReducer.aspirationDetails
  );
  return {
