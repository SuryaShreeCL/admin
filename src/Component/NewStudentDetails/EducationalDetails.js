...
export class EducationalDetails extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    var findObj = this.props.studentStatusResponse.find(
      res => res.section && res.section.name === "Educational Details'"
    );
    console.log(findObj);

    if (findObj !== undefined) {
      if (findObj.section.name === "Educational Details'") {
    ...
    if (
      this.props.updateEducationalonalResponse !==
      prevProps.updateEducationalonalResponse
    ) {
      this.setState({
  ...
  handleSubmit = () => {
    ...
    this.state.backlogs === null || this.state.backlogs.toString().length === 0
    ...
    if (
      ...
      let obj = {
        ...
        noOfBacklogs:
          this.state.backlogs === 0 || this.state.backlogs === '0'
            ? 100
            : parseInt(this.state.backlogs),
        noOfClearedBacklogs:
          this.state.clearBacklogs === 0 || this.state.clearBacklogs === '0'
            ? 100
            : parseInt(this.state.clearBacklogs),
...
const mapStateToProps = state => {
  return {
    ...
    updateEducationalonalResponse:
      state.AdminReducer.updateEducationalonalResponse,
