...
export default class Pgaplan extends Component {
  ...
  type = [{ title: "Above Average" }, { title: "Below Average" }];
  renderAmbitious = () => {
    let ambitiousArr = [];
          ...
          <FormControl size="small" fullWidth variant="outlined">
            ...
            >
              {this.specialization.map((eachChoice) => {
                return (
                  <MenuItem value={eachChoice.title}>
                    {eachChoice.title}
                  </MenuItem>
                );
              })}
            ...
            <Grid container spacing={2}>
              <Grid item md={6}>
                <IconButton
                  onClick={() =>
                    this.setState({
                      ambitiousCount: this.state.ambitiousCount + 1,
                    })
                  }
                >
                  <Icon>
          ...
          <Grid item md={1}>
            <Grid container spacing={2}>
              <Grid item md={6}>
                <IconButton
                  onClick={() =>
                    this.setState({ casualCount: this.state.casualCount + 1 })
                  }
                >
                  <Icon>
                    <AddCircleIcon />
            ...
            <Grid container spacing={2}>
              <Grid item md={6}>
                <IconButton
                  onClick={() =>
                    this.setState({
                      balancedCount: this.state.balancedCount + 1,
                    })
                  }
                >
                  <Icon>
          ...
          <Grid item md={1}>
            <Grid container spacing={2}>
              <Grid item md={6}>
                <IconButton
                  onClick={() =>
                    this.setState({ exploCount: this.state.exploCount + 1 })
                  }
                >
                  <Icon>
                    <AddCircleIcon />
