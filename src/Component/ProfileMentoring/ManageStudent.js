...
export class ProfileMentorManageStudent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      shrink: false,
  ...
  handleManage = (eachItem) => {
    ...
    this.props.history.push(
      `${stagedTabsPath}${eachItem.studentId}/${productId}?stage=ProfileMentoring`
    );
  };
          ...
          <Grid item md={12}>
            <div style={HeadDisplay}>
              <Grid container spacing={3} alignItems={"center"}>
                <Grid item md={4}>
                  <p style={HeadStyle}>
                    {"List of Users in Profile Mentoring Stage"}
                  </p>
                </Grid>
                <Grid item md={3}>
                  <Autocomplete
