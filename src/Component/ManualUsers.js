...
import { getStudents, getStudentPaginate, postStudents, mernStudentSignUp, mernStudentEdit, getManualUser } from "../Actions/Student";
    ...
    return (
      <MuiThemeProvider theme={this.getmuitheme}>
        <div>
          ...
          {this.props.manualUserDetails.length !== 0 ? (
            <TableComponent
              data={
                this.props.manualUserDetails.length !== 0
                  ? this.props.manualUserDetails.content
                  : null
              }
              add={true}
              ...
              title={"Student"}
              pageCount={this.props.manualUserDetails.totalPages}
            />
          ) : (
...
const mapStateToProps = (state) => {
  return {
    ...
    manualUserDetails : state.StudentReducer.manualUserDetails,
...
export default connect(mapStateToProps, { getStudents, getStudentPaginate, postStudents, getAllColleges, getBranches, mernStudentSignUp, mernStudentEdit, getManualUser })(
    ManualUsers
);
