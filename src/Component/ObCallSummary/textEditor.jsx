...
class Question extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (this.props.getClientInfoList !== prevProps.getClientInfoList) {
      this.setState({
        questions:
          this.props.getClientInfoList.questions !== null
            ? this.props.getClientInfoList.questions
            : "",
        expectations:
          this.props.getClientInfoList.expectations !== null
            ? this.props.getClientInfoList.expectations
            : "",
        concerns:
          this.props.getClientInfoList.concerns !== null
            ? this.props.getClientInfoList.concerns
            : "",
        feedback:
          this.props.getClientInfoList.feedback !== null
            ? this.props.getClientInfoList.feedback
            : "",
      });
    }
  }
    ...
    return (
      <div>
        ...
        <Grid container spacing={2} style={{ paddingTop: 20 }}>
          ...
          <Grid item xs={12} sm={6}>
            <div style={{ color: "#686868", fontSize: 12 }}>Expectations</div>
          ...
          <Grid item xs={12} sm={6} style={{ marginTop: "-20px" }}>
            <div style={{ color: "#686868", fontSize: 12 }}>
              Concerns / Issues / Complaints (Testimonials, Trust Issues,
              Pricey, No Proven Track Record)
            </div>
