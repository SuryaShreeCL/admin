      ...
      <div>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item md={12} align="center">
            ...
            this.props.diagTestResult.length !== 0 ? (
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell align="left">
                        ...
                        >
                          <ExcelSheet
                            data={this.props.cvReport}
                            name="CV Rating Report"
                          >
                            <ExcelColumn
                    ...
                    <TableRow>
                      ...
                      <TableCell align="left">
                        ...
                        >
                          <ExcelSheet
                            data={this.props.markSheetReport}
                    ...
                    <TableRow>
                      ...
                      <TableCell align="left">
                        ...
                        >
                          <ExcelSheet
                            data={this.props.myDetailsReport}
                            name="My Details Report"
                          >
                            <ExcelColumn
                              label="STUDENT_ID"
                              value="STUDENT_ID"
                            ...
                            <ExcelColumn
                              ...
                              value={(col) =>
                                col["No.of Active Backlogs"] === "100"
                                  ? "0"
                                  : col["No.of Active Backlogs"]
                              }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) =>
                                col["No.of Cleared Backlogs"] === "100"
                                  ? "0"
                                  : col["No.of Cleared Backlogs"]
                              }
                            ></ExcelColumn>
                            <ExcelColumn
                              label="University"
                            ...
                            <ExcelColumn
                              ...
                              value={(col) =>
                                col["Present Semester"] === "100"
                                  ? "0"
                                  : col["Present Semester"]
                              }
                            ></ExcelColumn>
                            <ExcelColumn
                            ...
                            <ExcelColumn
                              ...
                              value="Verbal"
                            ></ExcelColumn>
                            <ExcelColumn label="AWA" value="AWA"></ExcelColumn>
                            <ExcelColumn
                              label="Total"
                              value="Total"
                            ></ExcelColumn>
                    ...
                    <TableRow>
                      ...
                      <TableCell align="left">
                        {"Technical Test Mechanical Report"}
                      </TableCell>
                      <TableCell align="left">
                        <ExcelFile
                        ...
                        >
                          <ExcelSheet
                            data={this.props.techTestMechReport}
                            name="Technical Test Mechanical Report"
                          >
                            <ExcelColumn
                              label="Student ID"
                              value="Student ID"
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.technicaltest !== null) {
                                  return col.technicaltest[
                                    '" What will be the change in specific entropy of an ideal gas when it is throttled from 10 bar,298 k to 4 bars? (approximately)(Tape R = 287 J/(kg-k)"'
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.technicaltest !== null) {
                                  return col.technicaltest[
                                    "During steady flow compression of a gas with mass flow rate of 2 kg/s, increase in specific enthalpy is 15 KJ/Kg and decrease in kinetic energy is 2 KJ/Kg . The rate of heat rejection to the environment is 3 kW. The power required to drive the compressor is __________."
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.technicaltest !== null) {
                                  return col.technicaltest[
                                    "A thin steel rule (E = 200 GPa) having thickness 20 mm and it is bent by couples Mo at the ends into a circular arc of length 25 cm subtending a central angle of 60o. What is maximum stress in the beam __________ (MPa)."
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.technicaltest !== null) {
                                  return col.technicaltest[
                                    " Which of the following statements is/are true for mechanisms?"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            ></ExcelColumn>
                            <ExcelColumn label="" value="score"></ExcelColumn>
                          </ExcelSheet>
                        </ExcelFile>
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell align="left">
                        {"Technical Test Electronics Report"}
                      </TableCell>
                      <TableCell align="left">
                        <ExcelFile
                        ...
                        >
                          ...
                          >
                            ...
                            <ExcelColumn
                              label={
                                'What is the output of this C code? int main() {int y = 1, x = 0;int l = (y++, x++) ? y : x;printf("%d\n", l); }'
                              }
                              value={(col) => {
                                if (col.technicaltest !== null) {
                                  return col.technicaltest[
                          ...
                          >
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.technicaltest !== null) {
                                  return col.technicaltest[
                                    "Which of the following can be used to add data to a database table?"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.technicaltest !== null) {
                                  return col.technicaltest[
                                    "Which of the following are also known as “inner join”?"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.technicaltest !== null) {
                                  return col.technicaltest[
                                    "How many times will 'CareerLabs' get printed?"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.technicaltest !== null) {
                                  return col.technicaltest[
                                    "________ is a pile in which items are added at one end and removed from the other"
                                  ];
                                } else {
                                  return null;
                                }
                    ...
                    <TableRow>
                      ...
                      <TableCell align="left">
                        ...
                        >
                          <ExcelSheet
                            data={this.props.careerReport}
                            name="Career Interest Test Report"
                          >
                            {/* {
                          ...
                          return(
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "How did you choose your undergraduate field of study (Eg. mechanical engineering, computer science engineering, etc.)?Others"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "From the following, what is your first preference for a career option immediately after graduation?Others"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What would you look for in your ideal job?Pay"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What would you look for in your ideal job?Growth"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What would you look for in your ideal job?Applying what you studied"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What would you look for in your ideal job?Working with people from different backgrounds"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What would you look for in your ideal job?Others"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Build a system to automatically recognise different food items"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Recruit new employees and design employee benefit program"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Develop systems where multiple devices that talk to each other]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Design User Interface and User experience for different web and mobile applications"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Generate more revenue for the bank by bringing in customers]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Use design software to model, test, and create products/assemblies"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Recognise and analyse patterns in large datasets"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Help business grow by improving their sales"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Design and develop machines that replace humans for various activities.]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Create my own 3D animated film like Kungfu Panda]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Analyse stocks and forecast capital markets ]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Design machinery for large manufacturing companies"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What are your top three favorite subjects in your undergraduate field of study?1"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What are your top three favorite subjects in your undergraduate field of study?2"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What are your top three favorite subjects in your undergraduate field of study?3"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What electives are you taking in the current semester or will be taking in the coming semester?1"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What electives are you taking in the current semester or will be taking in the coming semester?2"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What electives are you taking in the current semester or will be taking in the coming semester?3"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "Would you like to pursue a career in your undergraduate your field of study?"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "How would you go about selecting your career paths?Others"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Develop captivating responsive websites and manage databases"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interestI would like to: [Promote Products or Services to End Customer using different social media channels]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Explore an interdisciplinary field which combines Mechanics,Electronics, Automation and Computers."
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interestI would like to: [Create an explosion scene for an action film]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interestI would like to: [Prevent fraudulent losses for business]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Evaluate, analyze maintain boilers or turbo machinery"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Take part in competitions and solve coding problems"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Plan, organize, and direct the completion of specific projects for an organization"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Design dedicated computer hardware and software for intelligent devices"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "Great Progress so far!On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Work on Augmented reality and Virtual Reality]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "Great Progress so far!On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Manage wealth of high net worth individuals for their future needs]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Perform structural analysis using hand calculations and finite element analysis software"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What outcomes do you want from your journey with the CareerLabs Profile Builder for Placement ?Others"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What are your top three hobbies?1"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What are your top three hobbies?2"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What are your top three hobbies?3"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Process analyse digital images that enable computers to see]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Manage the process that transforms inputs to outputs in an organisation]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Build the next 8G network]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Be a part of developing PC or mobile games"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what would you like to do? Select atleast one option that is closest to your interest.I would like to: [Process and settle financial transactions for trading desks]"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "On a regular basis at work, what is it that you would really like to do?Develop numerical programs to drive NC and CNC tools"
                                  ];
                                } else {
                                  return null;
                                }
                            ...
                            <ExcelColumn
                              ...
                              value={(col) => {
                                if (col.TestAnswer !== null) {
                                  return col.TestAnswer[
                                    "What are the Top 3 subjects you Hate in your undergraduate studies\nso far?1"
                                  ];
                                } else {
                                  return null;
                                }
