            ...
            <Table aria-label="simple table">
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell align="left">{"Electronics Report"}</TableCell>
                  <TableCell align="left">
                    <ExcelFile
                      ...
                      >
                        ...
                        ></ExcelColumn>
                         <ExcelColumn
                          ...
                          value={
                            (col)=>{
                              if(col.technicaltest !== null){
                               return col.technicaltest.['What is the output of this C code? int main() {char *p = NULL;char *q = 0;if (p)printf(" p ");elseprintf("nullp");if (q) printf("q\n");elseprintf(" nullq\n"); }']
                              }else{
                                return null
                              }
                            }
                        ...
                        <ExcelColumn
                          ...
                          value={
                            (col)=>{
                              if(col.technicaltest !== null){
                               return col.technicaltest.["The conversion resolution of an 8-stage counter operating an 8-stage ladder network using a reference voltage of 5 V is ________."]
                              }else{
                                return null
                              }
                            }
                        ...
                        ></ExcelColumn>
                         <ExcelColumn
                          ...
                          value={
                            (col)=>{
                              if(col.technicaltest !== null){
                               return col.technicaltest.['How many times will "CareerLabs" get printed?int main(){int x;for(x=-1; x&lt;=10; x++){if(x &lt; 5)continue;elsebreak;printf("Careerlabs");}return 0;}']
                              }else{
                                return null
                              }
                            }
