...
export class Courses extends Component {
  ...
  newCourse = () => {
    ...
    isEmptyString(this.state.lmsURL)
      ? this.setState({ lmsErr: hlptxt })
      : this.setState({ lmsErr: "" });
    ...
    isEmptyString(this.state.description)
      ? this.setState({ descErr: hlptxt })
      : this.setState({ descErr: "" });
    isEmptyString(this.state.displayImageURL)
      ? this.setState({ displayImageURLErr: hlptxt })
      : this.setState({ displayImageURLErr: "" });
    isEmptyString(this.state.thumnailImageURL)
      ? this.setState({ thumbnailErr: hlptxt })
      : this.setState({ thumbnailErr: "" });
              ...
              <Grid container spacing={2}>
                ...
                <Grid item md={4}>
                  <TextField
                    ...
                    onChange={(e) =>
                      this.setState({ thumnailImageURL: e.target.value })
                    }
                    multiline
                  />
                </Grid>
                ...
                <Grid item md={4}>
                  <Autocomplete
                    ...
                    onChange={(e, newValue) =>
                      this.setState({ subdomain: newValue })
                    }
                    renderInput={(params) => (
                      <TextField
                        {...params}
                ...
                <Grid item md={4}>
                  <Autocomplete
                    ...
                    onChange={(e, newValue) =>
                      this.setState({ productvariant: newValue })
                    }
                    renderInput={(params) => (
                      <TextField
                        {...params}
                ...
                <Grid item md={4}>
                  <Autocomplete
                    ...
                    onChange={(e, newValue) =>
                      this.setState({ advancecourse: newValue })
                    }
                    renderInput={(params) => (
                      <TextField
                        {...params}
