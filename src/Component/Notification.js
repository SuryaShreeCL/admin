...
export class Notification extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      this.props.updatenotificationList !== prevProps.updatenotificationList
    ) {
      this.props.viewnotification();
    }
  ...
  newNotify = () => {
    ...
    isEmptyString(this.state.code)
      ? this.setState({ codeErr: helperTxt })
      : this.setState({ codeErr: "" });
    isEmptyString(this.state.featureName)
      ? this.setState({ featureNameErr: helperTxt })
      : this.setState({ featureNameErr: "" });
    isEmptyString(this.state.completedTask)
      ? this.setState({ completedTaskErr: helperTxt })
      : this.setState({ completedTaskErr: "" });
    isEmptyString(this.state.firstDay)
      ? this.setState({ firstDayErr: helperTxt })
      : this.setState({ firstDayErr: "" });
    isEmptyString(this.state.secondDay)
      ? this.setState({ secondDayErr: helperTxt })
      : this.setState({ secondDayErr: "" });
    isEmptyString(this.state.thirdDay)
      ? this.setState({ thirdDayErr: helperTxt })
      : this.setState({ thirdDayErr: "" });
    isEmptyString(this.state.fourthDay)
      ? this.setState({ fourthDayErr: helperTxt })
      : this.setState({ fourthDayErr: "" });
    isEmptyString(this.state.fifthDay)
      ? this.setState({ fifthDayErr: helperTxt })
      : this.setState({ fifthDayErr: "" });
    isEmptyString(this.state.sixthDay)
      ? this.setState({ sixthDayErr: helperTxt })
      : this.setState({ sixthDayErr: "" });
    isEmptyString(this.state.seventhDay)
      ? this.setState({ seventhDayErr: helperTxt })
      : this.setState({ seventhDayErr: "" });
    isEmptyString(this.state.tenMinutes)
      ? this.setState({ tenMinutesErr: helperTxt })
      : this.setState({ tenMinutesErr: "" });
    {
              ...
              <Grid container spacing={3}>
                ...
                <Grid item md={4}>
                  <TextField
                    ...
                    onChange={(e) =>
                      this.setState({ thirdDay: e.target.value })
                    }
                    multiline
                  />
                </Grid>
                <Grid item md={4}>
                  <TextField
                    ...
                    onChange={(e) =>
                      this.setState({ fourthDay: e.target.value })
                    }
                    multiline
                  />
                </Grid>
                <Grid item md={4}>
                  <TextField
                    ...
                    onChange={(e) =>
                      this.setState({ fifthDay: e.target.value })
                    }
                    multiline
                  />
                </Grid>
                <Grid item md={4}>
                  <TextField
                    ...
                    onChange={(e) =>
                      this.setState({ sixthDay: e.target.value })
                    }
                    multiline
                  />
                </Grid>
                <Grid item md={4}>
                  <TextField
                    ...
                    onChange={(e) =>
                      this.setState({ seventhDay: e.target.value })
                    }
                    multiline
                  />
                </Grid>
                <Grid item md={4}>
                  <TextField
                    ...
                    onChange={(e) =>
                      this.setState({ tenMinutes: e.target.value })
                    }
                    multiline
                  />
                </Grid>
