...
export class CareerInterest2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      questionId: "",
  ...
  render() {
    ...
    if (this.state.questionId != null && this.state.choices != null) {
      window.sessionStorage.setItem(
        ...
        JSON.stringify(CareerInterestCategory)
      );
    }
              ...
              <>
                ...
                <div className="item-body">
                  <FormControl component="fieldset">
                    <FormGroup>
                      {qus.choices.slice(0, 4).map((option) => (
                        <FormControlLabel
                          control={
                            <Checkbox
                              color="primary"
...
export default connect(mapStateToprops, { getQuestions })(CareerInterest2);
