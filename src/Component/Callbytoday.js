import {
  ...
  class CallByToday extends Component {
    constructor(props){
      super(props);
      this.state = {
        data : []
    ...
    render() {
      ...
      const finaldate = this.state.data.filter(filterdate=>filterdate.accurateDate === currentdate)
        ...
        <div>
          ...
          <TableContainer>
            <Table>
              ...
              <TableBody>
              {/* {this.state.data.filter(sample=>sample.accurateDate === currentdate).map(content=>( */}
  ...
  const Transition = React.forwardRef(function Transition(props, ref) {
    ...
    export default connect(mapStateToprops,{viewschedule})(CallByToday)
