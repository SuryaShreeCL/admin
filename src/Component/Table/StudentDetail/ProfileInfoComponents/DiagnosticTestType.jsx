...
export class DiagnosticTestType extends Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
  ...
  renderStudent = () => {   
    ...
    return diagnosticTestObj.map((row)=>{
        return(                                
...
export default connect(mapStateToProps, { getStudentsById })(DiagnosticTestType);
