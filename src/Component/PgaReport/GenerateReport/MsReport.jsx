  ...
  <View>
    ...
    {isEmpty(spiderGraph) && (
      <>
        ...
        <Text style={{ ...styles.small, ...styles.p_10 }}>{descriptionOne}</Text>
        <Text style={{ ...styles.small, ...styles.p_15 }}>{descriptionTwo}</Text>
        {spiderGraph.map((data) => (
          <View style={styles.spider_graph_card}>
            <View style={styles.plan_left_view}>
              ...
              <Text style={styles.spider_graph_left_title}>Preferred Career Track</Text>
              <Text style={styles.spider_graph_left_title}>Course Selection 1</Text>
              <Text style={styles.spider_graph_left_title}>Course Selection 2</Text>
            </View>
            <View style={styles.plan_right_view}>
              <Text style={styles.spider_graph_left_title_text}>{data.plan}</Text>
              <Text style={styles.spider_graph_left_title_text}>{data.career}</Text>
              <Text style={styles.spider_graph_left_title_text}>{data.courseOne}</Text>
              <Text style={styles.spider_graph_left_title_text}>{data.courseTwo}</Text>
            </View>
    ...
    <Document>
      <Page style={styles.body}>
        <View style={styles.analysis_title_div}>
          <Text style={styles.title}>Minutes of the Profile Gap Analysis Session</Text>
          ...
          content.map((item, idx) => {
            ...
            return (
              <MyDocument
                ...
                isGreenCardVisible={content.inTake && content.description && content.description}
                isSecondaryPassageVisible={
                  isEmpty(content.title) && isEmpty(descriptionOne) && isEmpty(descriptionTwo)
                }
        ...
        <View style={styles.footer}>
          <Text style={styles.small}>
            Do write to us at <Link> msconsulting@thecareerlabs.com</Link> if you have any queries
            or concerns.
          </Text>
        </View>
      </Page>
