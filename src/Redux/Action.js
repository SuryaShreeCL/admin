...
export const THIRDYEARWEBINAR = {
  // LIST_REQUEST: 'WALL_LIST_REQUESTED',
  // LIST_SUCCESS: 'WALL_LIST_SUCCESSFUL',
  // LIST_FAIL: 'WALL_LIST_FAILED',

  WEBINAR_LIST_REQUEST: "THIRDYEAR_LIST_REQUESTED",
  WEBINAR_LIST_SUCCESS: "THIRDYEAR_LIST_SUCCESSFUL",
  WEBINAR_LIST_FAIL: "THIRDYEAR_LIST_FAILED",
