...
export const TEST = {
  ...
  QUESTION_SET_UPLOAD_REQUEST: 'TEST_QUESTION_SET_UPLOAD_REQUEST',
  QUESTION_SET_UPLOAD_SUCCESS: 'TEST_QUESTION_SET_UPLOAD_SUCCESS',
  QUESTION_SET_UPLOAD_FAIL: 'TEST_QUESTION_SET_UPLOAD_FAIL',
  QUESTION_SET_UPLOAD_RESET: 'TEST_QUESTION_SET_UPLOAD_RESET',
